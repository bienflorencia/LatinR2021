...
``` {r, echo=FALSE, fig.cap='Índice temporal (densidad de registros en el tiempo)'}
ggplot() + 
...
``` {r, echo=FALSE, fig.cap='Índice espacial (densidad de registros)'}
ggplot() + 
...
```{r, fig.cap='Zonas prioritarias donde ir a registrar observaciones'}
...
Las grillas con valores de **rojo** más intenso, son sitios donde hasta el momento NO existen observaciones cargadas en la plataforma iNaturalist para Uruguay.
